    ...
    /* routes() {
        ...
        this.router.post('/ACCER', async (req, res) => {
            ...
            if (consaltant == null) {
                ...
                let ConsaltantAfterUpdate = await new ConsaltantBuss().AddCeritifications(consaltant._id, Certification);
                if (ConsaltantAfterUpdate == null) {
                    res.status(200).json({
        ...
        this.router.post('/UCCER', async (req, res) => {
            ...
            if (consaltant == null) {
                ...
                let Certification = req.body.Certification
                let ConsaltantAfterUpdate = await new ConsaltantBuss().UpdateCeritifications(consaltant._id, Certification);
                if (ConsaltantAfterUpdate == null) {
                    res.status(200).json({
                        meesage: "Certification not Added"
                    })
        ...
        this.router.post('/RCCER', async (req, res) => {
            ...
            if (consaltant == null) {
                ...
                let ConsaltantAfterUpdate = await new ConsaltantBuss().RemoveCeritifications(consaltant._id, Certification_ID);
                if (ConsaltantAfterUpdate == null) {
                    res.status(200).json({
        ...
        this.router.post('/RTEHSK', async (req, res) => {
            ...
            if (consaltant == null) {
                ...
                let ConsaltantAfterUpdate = await new ConsaltantBuss().RemoveTechnical_Skills(consaltant._id, TECHNI_ID);
                if (ConsaltantAfterUpdate == null) {
                    res.status(200).json({
...
export const consalRoutes = new ConsaltantsRoutes().router